...
interface SystemDataContextType {
  ...
  addSection: (name: string, divisionId: string) => Promise<void>;
  updateSection: (id: string, name: string, divisionId: string) => Promise<void>;
  deleteSection: (id: string) => Promise<void>;
  addLocation: (name: string) => Promise<void>;
  updateLocation: (id: string, name: string) => Promise<void>;
  deleteLocation: (id: string) => Promise<void>;
  addStatusOption: (name: string) => Promise<void>;
  updateStatusOption: (id: string, name: string) => Promise<void>;
